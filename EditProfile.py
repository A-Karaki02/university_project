...
from PySide6.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QPushButton, QVBoxLayout,QComboBox,QGridLayout,QHBoxLayout
...
class Editprofile(QWidget):
    ...
    def initUI(self):
        ...
        self.add_button("Save Changes return MainPage",5,5,grid_layout,self.openHome_Page)
    ...
    def add_textbox(self, label_text, layout,row,col):
        ...
        textbox.setStyleSheet("background-color: rgb(255, 255, 255); color: rgb(0, 0, 0);")
    ...
    def add_dynamic_label(self,text, layout,row,col):
        label = QLabel(text)
        label.setStyleSheet("font-size: 18px;color: rgb(140, 140, 140); ;font-style: italic;font-weight: bold;")
        label.setAlignment(Qt.AlignCenter)
